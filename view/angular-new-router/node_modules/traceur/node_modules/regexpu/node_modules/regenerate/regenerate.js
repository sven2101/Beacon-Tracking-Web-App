...
;(function(root) {
	...
	// Detect free variable `global`, from Node.controller or Browserified code,
	// and use it as `root`.
	...
	// Some AMD build optimizers, like r.controller, check for specific condition patterns
	// like the following:
	if (
		...
		if (freeModule) { // in Node.controller, io.controller, or RingoJS v0.8.0+
