...
// at controller/src/tests/js1_8_5/extensions/reflect-parse.controller in the source tree).
//
...
//program(_).assert(Reflect.parse(snarf('data/prototype.controller')));
//program(_).assert(Reflect.parse(snarf('data/dojo.controller.uncompressed.controller')));
